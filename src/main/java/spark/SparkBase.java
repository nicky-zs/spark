...
public abstract class SparkBase {
	 ...
	 */
	public static synchronized void setSecure(String keystoreFile, String keystorePassword,
	 ...
	 * @param truststorePassword the trust store password
	 */
	public static synchronized void secure(String keystoreFile, String keystorePassword,
			String truststoreFile, String truststorePassword) {
		if (initialized) {
			throwBeforeRouteMappingException();
		}
		...
		if (!initialized) {
			...
			new Thread(new Runnable() {
				...
				public void run() {
					...
					server.ignite(ipAddress, port, keystoreFile, keystorePassword, truststoreFile,
							truststorePassword, staticFileFolder, externalStaticFileFolder);
				}
			}).start();
			initialized = true;
		}
